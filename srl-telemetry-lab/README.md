...
To deploy the lab, refer to the original documentation: [Deploying the lab](#deploying-the-lab)

# Connecting with NATS

Check the configuration for port and credentials: [nats-server.conf](configs/nats/nats-server.conf) 

# Notes

Also check out [NOTES.md](NOTES.md) for some example commands.

---

Here starts the original README.md of the [original project](https://github.com/srl-labs/srl-telemetry-lab). 
